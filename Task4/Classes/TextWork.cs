...
namespace Classes
{
    ...
    public class TextWork
    {
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public static string ReverseRegister(string text)
        {
            string newText = "";
            for(int i = 0; i < text.Length; i++)
            {
                if (Char.IsUpper(text[i])) newText += text[i].ToString().ToLower();
                else newText += text[i].ToString().ToUpper();
            }
            return newText;
        }

        /// <summary>
        /// Delete digits from text
        /// </summary>
        /// <param name="text"></param>
        /// <returns></returns>
        public static string DeleteDigits(string text)
        {
            ...
            for (int i = 0; i < text.Length; i++)
            {
                if (!Char.IsDigit(text[i])) newText += text[i].ToString();
            }
            return newText;
        }
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public static string DeleteLetters(string text)
        {
            string newText = "";
            for (int i = 0; i < text.Length; i++)
            {
                if (!Char.IsLetter(text[i])) newText += text[i].ToString();
            }
            return newText;
        }
    }
